...
use crate::worker::{WorkItem, WorkResult, Worker};
use anyhow::Result;
...
impl SimpleCrawler {
    ...
    pub fn new(storage: Storage, max_depth: usize, num_workers: usize, start_url: Url) -> Self {
    ...
    pub async fn crawl(&mut self) -> Result<()> {
        println!(
            "Starting crawler with {} workers, max depth {}",
